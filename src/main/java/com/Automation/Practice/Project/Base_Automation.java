...
public class Base_Automation {
	...
	public static WebDriver getBrowser(String type) {
		...
		if (type.equalsIgnoreCase("chrome")) {
			...
			System.setProperty("webdriver.gecko.driver",
					System.getProperty("user.dir") + "\\Driver\\geckodriver-v0.30.0-win32\\geckodriver.exe");
	...
	public static void data(WebElement ele, String type) {
		ele.sendKeys(type);
	...
	public static void takeScreenShot() throws IOException {
		...
		File destination = new File("C:\\Users\\PATAMA\\eclipse-workspace\\Selenium_Start\\Screenshot\\project.png");
